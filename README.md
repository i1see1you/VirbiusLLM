...
**详细设计**：[docs/DESIGN.md](docs/DESIGN.md)（规则 **`runtime`** / **`enforce_mode`** 见 [§8.5.0](docs/DESIGN.md)） · **PoC 种子与运营 API**：[docs/POC-SEED-API.md](docs/POC-SEED-API.md) · **MVP 接口契约**：[docs/openspec/](docs/openspec/) · **PoC 代码布局**：[docs/POC-REPO.md](docs/POC-REPO.md)
